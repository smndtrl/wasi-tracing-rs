...
#[link_section = "component-type:wit-bindgen:0.21.0:test-reactor:encoded world"]
#[doc(hidden)]
...
\x01\x1awasmtime:wasi/test-reactor\x04\0\x0b\x12\x01\0\x0ctest-reactor\x03\0\0\0\
